...
Modal.prototype['show'] = function (relatedTarget) {
  ...
  document.body.classList.add(Modal._ClassName.OPEN)
...
Modal.prototype['hide'] = function (event) {
  ...
  this._element.classList.remove(Modal._ClassName.IN)
  this._element.setAttribute('aria-hidden', true)

  $(this._element).off('click.dismiss.bs.modal')

  if (Bootstrap.transition && this._element.classList.contains(Modal._ClassName.FADE)) {
    $(this._element)
...
Modal.prototype._showElement = function (relatedTarget) {
  var transition = Bootstrap.transition && this._element.classList.contains(Modal._ClassName.FADE)
  ...
  this._element.classList.add(Modal._ClassName.IN)
  ...
  if (transition) {
    var dialog = this._element.querySelector(Modal._Selector.DIALOG)
    $(dialog)
...
Modal.prototype._hideModal = function () {
  ...
  this._showBackdrop(function () {
    document.body.classList.remove(Modal._ClassName.OPEN)
...
Modal.prototype._showBackdrop = function (callback) {
  var animate = this._element.classList.contains(Modal._ClassName.FADE) ? Modal._ClassName.FADE : ''

  if (this._isShown && this._config.backdrop) {
    var doAnimate = Bootstrap.transition && animate

    this._backdrop = document.createElement('div')
    this._backdrop.classList.add(Modal._ClassName.BACKDROP)
    ...
    this._backdrop.classList.add(Modal._ClassName.IN)
    ...
    this._backdrop.classList.remove(Modal._ClassName.IN)
