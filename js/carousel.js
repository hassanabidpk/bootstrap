...
var Carousel = function (element, opt_config) {
  ...
  /** @private {Element} */
  this._indicatorsElement = this._element.querySelector(Carousel._Selector.INDICATORS)
...
Carousel._dataApiClickHandler = function (event) {
  ...
  if (!target || !target.classList.contains(Carousel._ClassName.CAROUSEL)) {
    return
  }
...
Carousel.prototype['pause'] = function (opt_event) {
  ...
  if (this._element.querySelector(Carousel._Selector.NEXT_PREV) && Bootstrap.transition) {
...
Carousel.prototype.to = function (index) {
  this._activeElement = this._element.querySelector(Carousel._Selector.ACTIVE_ITEM)
...
Carousel.prototype._getItemIndex = function (element) {
  this._items = element.parentNode.querySelectorAll(Carousel._Selector.ITEM)
...
Carousel.prototype._setActiveIndicatorElement = function (element) {
  if (this._indicatorsElement) {
    this._indicatorsElement.querySelector(Carousel._Selector.ACTIVE_ITEM).classList.remove(Carousel._ClassName.ACTIVE)

    var nextIndicator = this._indicatorsElement.children[this._getItemIndex(element)]
    if (nextIndicator) {
      nextIndicator.classList.add(Carousel._ClassName.ACTIVE)
    }
  }
}
...
Carousel.prototype._slide = function (direction, opt_nextElement) {
  var activeElement = this._element.querySelector(Carousel._Selector.ACTIVE_ITEM)
  ...
  if (nextElement && nextElement.classList.contains(Carousel._ClassName.ACTIVE)) {
    this._isSliding = false
    return
  }
  ...
  var slidEvent = $.Event(Carousel._Event.SLID, { relatedTarget: nextElement, direction: direction })

  if (Bootstrap.transition && this._element.classList.contains(Carousel._ClassName.SLIDE)) {
    ...
    $(activeElement)
      .one(Bootstrap.TRANSITION_END, function () {
        ...
        nextElement.classList.add(Carousel._ClassName.ACTIVE)

        activeElement.classList.remove(Carousel._ClassName.ACTIVE)
