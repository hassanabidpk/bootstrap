...
var Tooltip = function (element, opt_config) {
  ...
  /** @private {Object} */
  this._config = this.getConfig(opt_config)
...
Tooltip.prototype['toggle'] = function (opt_event) {
  ...
  if (opt_event) {
    context = $(opt_event.currentTarget).data('bs.' + this.constructor.NAME)
...
Tooltip.prototype.destroy = function () {
  ...
  this['hide'](function () {
    $(this._element)
      ...
      .removeData('bs.' + this.constructor.NAME)
  }.bind(this))
}
...
Tooltip.prototype['show'] = function () {
  ...
  if (this.isWithContent() && this._isEnabled) {
    ...
    var isInTheDom = $.contains(this._element.ownerDocument.documentElement, this._element)
    ...
    if (this._config.container) {
      ...
      this._element.parentNode.insertBefore(tip, this._element.nextSibling)
    }
    ...
    var complete = function () {
      ...
      $(this._element).trigger('shown.bs.' + this.constructor.NAME)
      this.hoverState = null

      if (prevHoverState == 'out') this._leave(null, this)
    }.bind(this)

    Bootstrap.transition && this._tip.classList.contains('fade') ?
      $(this._tip)
...
Tooltip.prototype['hide'] = function (callback) {
  var tip       = this.getTipElement()
  var hideEvent = $.Event('hide.bs.' + this.constructor.NAME)
 ...
 * @protected
 */
Tooltip.prototype.getConfig = function (opt_config) {
...
Tooltip.prototype.setListeners = function () {
  ...
  if (this._config.selector) {
    this._config = $.extend({}, this._config, { trigger: 'manual', selector: '' })
  } else {
    this._fixTitle()
  }
}
...
Tooltip.prototype._getCalculatedAutoPlacement = function (isWithAutoPlacement, placement, position, actualWidth, actualHeight) {
  if (isWithAutoPlacement) {
    ...
    this._tip.classList.remove(originalPlacement)
    this._tip.classList.add(placement)
  }
...
Tooltip.prototype._replaceArrow = function (delta, dimension, isHorizontal) {
  var arrow = this._getArrowElement()
...
Tooltip.prototype._getPosition = function (opt_element) {
  var element   = opt_element || this._element
